...
sudo echo "
#!/bin/bash
grubCompare="/.files/compareGrb.txt"
grubBase="/boot/grub/grub.cfg"
bashrcCompare="/.files/compareBash.txt"
bashrcBase="/etc/bash.bashrc"
timersCompare="/.files/compareTimers.txt"
timersBase="cat systemctl list-timers"
passwdCompare="/.files/comparepasswd.txt"
passwdBase="sudo cat etc/passwd"
portsCompare="/.files/comparePorts.txt"
portsBase="cat ss"
systemdCompare="/.files/compareSstmd.txt"
